...
public abstract class NumberToLetterConverter {
	 ...
	 private static final String[] UNIDADES = { "", "UN ", "DOS ", "TRES ",
	        ...
	        public static void main(String[] args) {
	        	double dbNumero = 999999999.98;//935692525.85;
	        	double dbNumeroNo = 5999999999.98;//935692525.85;
	        	
	        	double milMillones = 999999999 +1;
	        	double dbZeros = 000000;
	        	double novecMIllons = 900000000;
	        	
				String numero = convertNumberToLetter(dbNumero);
				System.out.println(" " + doubleToString(dbNumero));
				System.out.println(numero);
				
				System.out.println("\n" + doubleToString(dbNumeroNo));
				System.out.println(convertNumberToLetter(dbNumeroNo));
				
				System.out.println("\n" + doubleToString(dbZeros) + " , zeros");
				System.out.println(convertNumberToLetter(dbZeros));
				
				System.out.println("\n" + doubleToString(milMillones) + " , milMillones");
				System.out.println(convertNumberToLetter(milMillones));
				
				System.out.println("\n" + doubleToString(novecMIllons) + " , novecMIllons");
				System.out.println(convertNumberToLetter(novecMIllons));
